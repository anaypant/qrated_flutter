...
class EconomyCommentsWidget extends StatefulWidget {
  const EconomyCommentsWidget({
    Key? key,
    this.ref,
  }) : super(key: key);

  final EconomyNewsRecord? ref;

  @override
  _EconomyCommentsWidgetState createState() => _EconomyCommentsWidgetState();
}

class _EconomyCommentsWidgetState extends State<EconomyCommentsWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  final economyNewsUpdateData = createEconomyNewsRecordData(
                    commentCt: widget.ref!.comments!.toList().length,
                  );
                  await widget.ref!.reference.update(economyNewsUpdateData);
                  context.pop();
                },
              ),
            ],
