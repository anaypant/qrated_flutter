...
class TrendingCommentsWidget extends StatefulWidget {
  const TrendingCommentsWidget({
    Key? key,
    this.ref,
  }) : super(key: key);

  final TrendingNewsRecord? ref;

  @override
  _TrendingCommentsWidgetState createState() => _TrendingCommentsWidgetState();
}

class _TrendingCommentsWidgetState extends State<TrendingCommentsWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  final trendingNewsUpdateData = createTrendingNewsRecordData(
                    commentCt: widget.ref!.comments!.toList().length,
                  );
                  await widget.ref!.reference.update(trendingNewsUpdateData);
                  context.pop();
                },
              ),
            ],
