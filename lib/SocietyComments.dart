...
class SocietyCommentsWidget extends StatefulWidget {
  const SocietyCommentsWidget({
    Key? key,
    this.ref,
  }) : super(key: key);

  final SocietyNewsRecord? ref;

  @override
  _SocietyCommentsWidgetState createState() => _SocietyCommentsWidgetState();
}

class _SocietyCommentsWidgetState extends State<SocietyCommentsWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  final societyNewsUpdateData = createSocietyNewsRecordData(
                    commentCt: widget.ref!.comments!.toList().length,
                  );
                  await widget.ref!.reference.update(societyNewsUpdateData);
                  context.pop();
                },
              ),
            ],
