...
part of 'society_news_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<SocietyNewsRecord> _$societyNewsRecordSerializer =
    new _$SocietyNewsRecordSerializer();

class _$SocietyNewsRecordSerializer
    implements StructuredSerializer<SocietyNewsRecord> {
  @override
  final Iterable<Type> types = const [SocietyNewsRecord, _$SocietyNewsRecord];
  @override
  final String wireName = 'SocietyNewsRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, SocietyNewsRecord object,
  ...
  @override
  SocietyNewsRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SocietyNewsRecordBuilder();
...
class _$SocietyNewsRecord extends SocietyNewsRecord {
  @override
  final String? title;
  @override
  final String? author;
  ...
  factory _$SocietyNewsRecord(
          [void Function(SocietyNewsRecordBuilder)? updates]) =>
      (new SocietyNewsRecordBuilder()..update(updates))._build();

  _$SocietyNewsRecord._(
      {this.title,
      this.author,
      this.description,
      this.publishedAt,
  ...
  @override
  SocietyNewsRecord rebuild(void Function(SocietyNewsRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SocietyNewsRecordBuilder toBuilder() =>
      new SocietyNewsRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SocietyNewsRecord &&
        title == other.title &&
        author == other.author &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SocietyNewsRecord')
          ..add('title', title)
          ..add('author', author)
...
class SocietyNewsRecordBuilder
    implements Builder<SocietyNewsRecord, SocietyNewsRecordBuilder> {
  _$SocietyNewsRecord? _$v;
  ...
  SocietyNewsRecordBuilder() {
    SocietyNewsRecord._initializeBuilder(this);
  }

  SocietyNewsRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _title = $v.title;
      _author = $v.author;
  ...
  @override
  void replace(SocietyNewsRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SocietyNewsRecord;
  }

  @override
  void update(void Function(SocietyNewsRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SocietyNewsRecord build() => _build();

  _$SocietyNewsRecord _build() {
    _$SocietyNewsRecord _$result;
    try {
      _$result = _$v ??
          new _$SocietyNewsRecord._(
              title: title,
              author: author,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SocietyNewsRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
