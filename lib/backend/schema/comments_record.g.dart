...
class _$CommentsRecord extends CommentsRecord {
  ...
  _$CommentsRecord._({this.displayName, this.comment, this.ffRef}) : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc(0, displayName.hashCode), comment.hashCode), ffRef.hashCode));
  }
  ...
  _$CommentsRecord _build() {
    final _$result = _$v ??
        new _$CommentsRecord._(
            displayName: displayName, comment: comment, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
