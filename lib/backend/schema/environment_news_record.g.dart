...
part of 'environment_news_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<EnvironmentNewsRecord> _$environmentNewsRecordSerializer =
    new _$EnvironmentNewsRecordSerializer();

class _$EnvironmentNewsRecordSerializer
    implements StructuredSerializer<EnvironmentNewsRecord> {
  @override
  ...
  @override
  final String wireName = 'EnvironmentNewsRecord';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, EnvironmentNewsRecord object,
  ...
  @override
  EnvironmentNewsRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new EnvironmentNewsRecordBuilder();
...
class _$EnvironmentNewsRecord extends EnvironmentNewsRecord {
  @override
  final String? title;
  @override
  final String? author;
  ...
  factory _$EnvironmentNewsRecord(
          [void Function(EnvironmentNewsRecordBuilder)? updates]) =>
      (new EnvironmentNewsRecordBuilder()..update(updates))._build();

  _$EnvironmentNewsRecord._(
      {this.title,
      this.author,
      this.description,
      this.publishedAt,
  ...
  @override
  EnvironmentNewsRecord rebuild(
          void Function(EnvironmentNewsRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EnvironmentNewsRecordBuilder toBuilder() =>
      new EnvironmentNewsRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EnvironmentNewsRecord &&
        title == other.title &&
        author == other.author &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EnvironmentNewsRecord')
          ..add('title', title)
          ..add('author', author)
...
class EnvironmentNewsRecordBuilder
    implements Builder<EnvironmentNewsRecord, EnvironmentNewsRecordBuilder> {
  _$EnvironmentNewsRecord? _$v;
  ...
  EnvironmentNewsRecordBuilder() {
    EnvironmentNewsRecord._initializeBuilder(this);
  }

  EnvironmentNewsRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _title = $v.title;
      _author = $v.author;
  ...
  @override
  void replace(EnvironmentNewsRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EnvironmentNewsRecord;
  }

  @override
  void update(void Function(EnvironmentNewsRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EnvironmentNewsRecord build() => _build();

  _$EnvironmentNewsRecord _build() {
    _$EnvironmentNewsRecord _$result;
    try {
      _$result = _$v ??
          new _$EnvironmentNewsRecord._(
              title: title,
              author: author,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'EnvironmentNewsRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
