...
part of 'trending_news_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<TrendingNewsRecord> _$trendingNewsRecordSerializer =
    new _$TrendingNewsRecordSerializer();

class _$TrendingNewsRecordSerializer
    implements StructuredSerializer<TrendingNewsRecord> {
  @override
  final Iterable<Type> types = const [TrendingNewsRecord, _$TrendingNewsRecord];
  @override
  final String wireName = 'TrendingNewsRecord';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, TrendingNewsRecord object,
  ...
  @override
  TrendingNewsRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new TrendingNewsRecordBuilder();
...
class _$TrendingNewsRecord extends TrendingNewsRecord {
  @override
  final String? title;
  @override
  final String? author;
  ...
  factory _$TrendingNewsRecord(
          [void Function(TrendingNewsRecordBuilder)? updates]) =>
      (new TrendingNewsRecordBuilder()..update(updates))._build();

  _$TrendingNewsRecord._(
      {this.title,
      this.author,
      this.description,
      this.publishedAt,
  ...
  @override
  TrendingNewsRecord rebuild(
          void Function(TrendingNewsRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TrendingNewsRecordBuilder toBuilder() =>
      new TrendingNewsRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TrendingNewsRecord &&
        title == other.title &&
        author == other.author &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TrendingNewsRecord')
          ..add('title', title)
          ..add('author', author)
...
class TrendingNewsRecordBuilder
    implements Builder<TrendingNewsRecord, TrendingNewsRecordBuilder> {
  _$TrendingNewsRecord? _$v;
  ...
  TrendingNewsRecordBuilder() {
    TrendingNewsRecord._initializeBuilder(this);
  }

  TrendingNewsRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _title = $v.title;
      _author = $v.author;
  ...
  @override
  void replace(TrendingNewsRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TrendingNewsRecord;
  }

  @override
  void update(void Function(TrendingNewsRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TrendingNewsRecord build() => _build();

  _$TrendingNewsRecord _build() {
    _$TrendingNewsRecord _$result;
    try {
      _$result = _$v ??
          new _$TrendingNewsRecord._(
              title: title,
              author: author,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'TrendingNewsRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
